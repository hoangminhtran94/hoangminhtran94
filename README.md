...
<br>
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,vue,php,laravel,firebase,figma,cs,java,html,css,docker,dotnet,graphql,mongodb,mysql,nestjs,netlify,nextjs,nodejs,postgres,prisma,remix,sqlite,svelte,tailwind,angular)](https://skillicons.dev)
